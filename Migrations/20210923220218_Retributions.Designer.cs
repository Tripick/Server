...
namespace TripickServer.Migrations
{
    ...
    [Migration("20210923220218_Retributions")]
    partial class Retributions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripickServer.Models.PlaceFlag", b =>
                {
                    ...
                    b.ToTable("PlaceFlags");
                });

            modelBuilder.Entity("TripickServer.Models.PlaceReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TripickServer.Models.Retribution", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TripickServer.Models.ReviewFlag", b =>
                {
                    ...
                    b.HasOne("TripickServer.Models.PlaceReview", "Review")
                        .WithMany("Flags")
            ...
            modelBuilder.Entity("TripickServer.Models.VoteReviewPlace", b =>
                {
                    ...
                    b.HasOne("TripickServer.Models.PlaceReview", "ReviewPlace")
                        .WithMany("Votes")
