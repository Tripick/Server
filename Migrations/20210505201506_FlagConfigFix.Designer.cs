...
namespace TripickServer.Migrations
{
    ...
    [Migration("20210505201506_FlagConfigFix")]
    partial class FlagConfigFix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TripickServer.Models.ConfigReviewFlag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("TripickServer.Models.ReviewFlag", b =>
                {
                    ...
                    b.Property<int>("IdReviewFlagConfig")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("IdReviewFlagConfig");

                    b.ToTable("ReviewFlag");
                });
            ...
            modelBuilder.Entity("TripickServer.Models.ReviewFlag", b =>
                {
                    ...
                    b.HasOne("TripickServer.Models.ConfigReviewFlag", "Config")
                        .WithMany()
                        .HasForeignKey("IdReviewFlagConfig")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
